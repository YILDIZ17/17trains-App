...
public class DestructorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String listHtml = getString(R.string.destructor);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent destructor = new Intent(DestructorActivity.this, MainActivity.class);
