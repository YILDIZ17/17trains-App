...
public class BuildYourEnduranceActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_build_your_endurance);

        // analyse le HTML pour liste à puces
        TextView textView4 = findViewById(R.id.textView4);
        String listHtml = getString(R.string.buildYourEndurance);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent buildYourEndurance = new Intent(BuildYourEnduranceActivity.this, MainActivity.class);
                startActivity(buildYourEndurance);
            }
        });
    }
