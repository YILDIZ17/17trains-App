...
public class WorkHardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String listHtml = getString(R.string.workHard);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent workHard = new Intent(WorkHardActivity.this, MainActivity.class);
                startActivity(workHard);
            }
        });
    }
