...
public class StreetWorkoutActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_street_workout);

        // analyse le HTML pour liste à puces
        TextView textView4 = findViewById(R.id.textView4);
        String listHtml = getString(R.string.streetWorkout);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent street_workout = new Intent(StreetWorkoutActivity.this, MainActivity.class);
