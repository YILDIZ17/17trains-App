...
public class FighterPowerActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fighter_power);

        // analyse le HTML pour liste à puces
        TextView textView4 = findViewById(R.id.textView4);
        String listHtml = getString(R.string.fighterPower);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent fighterPower = new Intent(FighterPowerActivity.this, MainActivity.class);
                startActivity(fighterPower);
            }
        });
    }
