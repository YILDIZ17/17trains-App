...
public class DestroyYourArmsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_destroy_your_arms);

        // analyse le HTML pour liste à puces
        TextView textView4 = findViewById(R.id.textView4);
        String listHtml = getString(R.string.destroyYouArms);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent destroyYourArms = new Intent(DestroyYourArmsActivity.this, MainActivity.class);
                startActivity(destroyYourArms);
            }
        });
    }
