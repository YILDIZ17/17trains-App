...
public class DumbellsPowerActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dumbells_power);

        // analyse le HTML pour liste à puces
        TextView textView4 = findViewById(R.id.textView4);
        String listHtml = getString(R.string.dumbellsPower);
        ...
        logo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent dumbellsPower = new Intent(DumbellsPowerActivity.this, MainActivity.class);
                startActivity(dumbellsPower);
            }
        });
    }
